...
- `Win+D`, `Win+Space`, `Win+/`, `Win+Shift+E`, `Win+W`, `Win+S`, `Win+M`, brightness keys, volume keys, screenshots, clipboard, web search, and power actions are mapped through Hyprland or local Quickshell IPC.
