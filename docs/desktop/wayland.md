...
GTK primary selection paste is enabled in both Hyprland profiles with `gsettings set org.gnome.desktop.interface gtk-enable-primary-paste true`, matching Omarchy middle-click behavior for GTK/Chromium apps.
