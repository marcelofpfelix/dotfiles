...
BorderSurface {
  ...
  implicitWidth: Math.max(minimumWidth, row.implicitWidth + horizontalPadding * 2 + _reservedBorderLeft + _reservedBorderRight)
  implicitHeight: Math.max(minimumHeight, row.implicitHeight + verticalPadding * 2 + _reservedBorderTop + _reservedBorderBottom)
