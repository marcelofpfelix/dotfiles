...
Panel {
  ...
  readonly property string heroStatusText: fullyCharged ? "Fully charged" : modeLabel()
  ...
  function setProfile(profile) {
    ...
    actionProc.command = ["power-status", "set-profile", profile]
  ...
  Process {
    id: batteryProc
    command: ["power-status", "shell"]
    stdout: StdioCollector { waitForEnd: true; onStreamFinished: root.updateKeyValue(text, "battery") }
  }

  Process {
    id: profilesProc
    command: ["power-status", "profiles"]
      ...
      Column {
        ...
        Row {
          ...
          Column {
            ...
            InfoPair { label: "Battery health"; value: root.batteryInfo.health || "-" }
          }
