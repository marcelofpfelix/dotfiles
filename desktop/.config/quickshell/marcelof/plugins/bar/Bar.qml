...
Item {
  ...
  Variants {
    model: root.shell && root.shell.laptopScreen ? [root.shell.laptopScreen] : Quickshell.screens
  ...
  component BarPanel: PanelWindow {
    ...
    Component.onCompleted: if (!root.primaryWindow) root.primaryWindow = barWindow
    Component.onDestruction: if (root.primaryWindow === barWindow) root.primaryWindow = null
