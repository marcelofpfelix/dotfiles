...
JsonAdapter {
  ...
  property string fontToken: "fira-code-retina"
  ...
  property var enabledPluginIds: ["marcelof.media-controls", "marcelof.network-tools", "omarchy.audio", "omarchy.bluetooth", "omarchy.network"]
}
